# Seestar Stacker
The little stacker for a lot of lights
...
Additional experimental strategies based on noise variance or estimated star FWHM can be enabled in advanced settings.
