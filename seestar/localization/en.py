...
EN_TRANSLATIONS = {
    ...
    'update_ref_every_label': "Update Ref Every:",
    ...
    'tooltip_update_ref_every': "Number of aligned frames after which the sliding reference is refreshed. 0 disables the feature.",
