...
EN_TRANSLATIONS = {
    ...
    "drizzle_processing_label": "Drizzle processing:",
    "drizzle_processing_standard": "Standard",
    "drizzle_processing_incremental": "Large dataset / incremental",
    "drizzle_group_size_label": "Preview group size:",
    "drizzle_processing_hint": "Standard and Large dataset share the same M3 accumulator; Large dataset only adds grouped preview/progress. Final result is identical.",
    ...
    "solver_label": "Solver",
    "solver_astap": "ASTAP",
    "solver_none": "No solver",
    "solver_zesolver": "ZeSolver",
    "solver_configure_zesolver": "Configure ZeSolver",
    "solver_configure_zesolver_failed": "Unable to configure ZeSolver.",
    "local_solver_astap_fallback_title": "ASTAP \u2014 autonomous fallback",
