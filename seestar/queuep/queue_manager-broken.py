...
# --- DANS LA CLASSE SeestarQueuedStacker ---
    ...
    def __init__(self):
        ...
        try:
            ...
            # Assurez-vous que l'import est en haut du fichier maintenant
            # from ..enhancement.color_correction import ChromaticBalancer
            ...
            self.chroma_balancer = None; raise # Rendre l'erreur fatale
        ...
        try:
            ...
            self.aligner = None; raise # Rendre l'erreur fatale

        print("==== FIN INITIALISATION SeestarQueuedStacker (Réorganisé) ====\n")

    # ... (reste des méthodes) ...
# --- Fin de la classe ---
    print("DEBUG QM: Fin du parsing du fichier queue_manager.py.")
...
##################################################################################################################
    ...
    def __init__(self):
        # ... (votre __init__ actuel) ...
        # Instancier ChromaticBalancer ici
        self.chroma_balancer = ChromaticBalancer(border_size=50, blur_radius=15)
        print("DEBUG QM __init__: ChromaticBalancer instancié.")
        self.aligner = SeestarAligner() # Assurer que l'aligneur est créé

    # --- Callbacks (Assurez-vous qu'ils sont définis) ---
    def set_progress_callback(self, callback):
