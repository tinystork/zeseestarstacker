...
# Dans la classe ZeMosaicGUI de zemosaic_gui.py
    ...
    def _build_ui(self):
        ...
        lang_label = ttk.Label(lang_select_frame, text=self._tr("language_selector_label"))
        ...
        ttk.Label(
            folders_frame,
            text=self._tr("input_folder_label"),
        ).grid(row=0, column=0, padx=5, pady=5, sticky="w"); self.translatable_widgets["input_folder_label"] = folders_frame.grid_slaves(row=0,column=0)[0]
        ...
        ).grid(row=0, column=2, padx=5, pady=5); self.translatable_widgets["browse_button"] = folders_frame.grid_slaves(row=0,column=2)[0]
        ttk.Label(
            folders_frame,
            text=self._tr("output_folder_label"),
        ).grid(row=1, column=0, padx=5, pady=5, sticky="w"); self.translatable_widgets["output_folder_label"] = folders_frame.grid_slaves(row=1,column=0)[0]
        ...
        ).grid(row=1, column=2, padx=5, pady=5); self.translatable_widgets["browse_button_output"] = folders_frame.grid_slaves(row=1,column=2)[0]

        ttk.Label(
            folders_frame,
            text=self._tr("save_final_16bit_label"),
        ).grid(row=2, column=0, padx=5, pady=5, sticky="w"); self.translatable_widgets["save_final_16bit_label"] = folders_frame.grid_slaves(row=2,column=0)[0]
        ...
        stk_opt_row = 0
        # Normalisation
        norm_label = ttk.Label(stacking_options_frame, text=self._tr("stacking_norm_method_label"))
        ...
        # Pondération
        weight_label = ttk.Label(stacking_options_frame, text=self._tr("stacking_weight_method_label"))
        ...
        # Rejet
        reject_label = ttk.Label(stacking_options_frame, text=self._tr("stacking_reject_algo_label"))
        ...
        kappa_low_label = ttk.Label(kappa_params_frame, text=self._tr("stacking_kappa_low_label")); kappa_low_label.pack(side=tk.LEFT, padx=(5,2)); self.translatable_widgets["stacking_kappa_low_label"] = kappa_low_label
        ...
        kappa_high_label = ttk.Label(kappa_params_frame, text=self._tr("stacking_kappa_high_label")); kappa_high_label.pack(side=tk.LEFT, padx=(5,2)); self.translatable_widgets["stacking_kappa_high_label"] = kappa_high_label
        ...
        winsor_label = ttk.Label(winsor_params_frame, text=self._tr("stacking_winsor_limits_label")); winsor_label.pack(side=tk.LEFT, padx=(5,2)); self.translatable_widgets["stacking_winsor_limits_label"] = winsor_label
        ...
        winsor_note = ttk.Label(winsor_params_frame, text=self._tr("stacking_winsor_note")); winsor_note.pack(side=tk.LEFT, padx=(5,0)); self.translatable_widgets["stacking_winsor_note"] = winsor_note; stk_opt_row += 1
        # Combinaison Finale MT
        combine_label = ttk.Label(stacking_options_frame, text=self._tr("stacking_final_combine_label"))
        ...
        # Pondération Radiale
        self.apply_radial_weight_label = ttk.Label(stacking_options_frame, text=self._tr("stacking_apply_radial_label"))
        ...
        # Feather Fraction
        self.radial_feather_label = ttk.Label(stacking_options_frame, text=self._tr("stacking_radial_feather_label"))
        ...
        self.min_radial_floor_label = ttk.Label(stacking_options_frame, text=self._tr("stacking_min_radial_floor_label"))
        ...
        min_radial_floor_note.grid(row=stk_opt_row, column=2, padx=5, pady=3, sticky="w"); self.translatable_widgets["stacking_min_radial_floor_note"] = min_radial_floor_note; stk_opt_row += 1
        ...
        num_workers_label = ttk.Label(perf_options_frame, text=self._tr("num_workers_label"))
        ...
        num_workers_note = ttk.Label(perf_options_frame, text=self._tr("num_workers_note"))
        ...
        self.apply_crop_label = ttk.Label(crop_options_frame, text=self._tr("apply_master_tile_crop_label"))
        ...
        self.crop_percent_label = ttk.Label(crop_options_frame, text=self._tr("master_tile_crop_percent_label"))
        ...
        crop_percent_note = ttk.Label(crop_options_frame, text=self._tr("master_tile_crop_percent_note"))
        ...
        self.re_solve_crop_label = ttk.Label(crop_options_frame, text=self._tr("re_solve_cropped_tiles_label"))
        ...
        asm_opt_row = 0
        self.final_assembly_method_label = ttk.Label(final_assembly_options_frame, text=self._tr("final_assembly_method_label"))
        ...
        ).pack(side=tk.LEFT, padx=(0,2)); self.translatable_widgets["eta_text_label"] = time_display_subframe.pack_slaves()[0]
        ...
        ).pack(side=tk.LEFT, padx=(0,2)); self.translatable_widgets["elapsed_text_label"] = time_display_subframe.pack_slaves()[2]
        ...
        self.tile_count_text_label_widget = ttk.Label(time_display_subframe, text=self._tr("tiles_text_label"))
